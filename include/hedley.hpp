...
#define HEDLEY_ARM_VERSION \
  HEDLEY_VERSION_ENCODE(__ARMCC_VERSION / 1000000, (__ARMCC_VERSION % 1000000) / 10000, (__ARMCC_VERSION % 10000) / 100)
#endif
...
#undef HEDLEY_GCC_VERSION
  ...
  !defined(HEDLEY_PGI_VERSION) && !defined(HEDLEY_ARM_VERSION) && !defined(HEDLEY_CRAY_VERSION) &&              \
  !defined(HEDLEY_TI_VERSION) && !defined(HEDLEY_TI_ARMCL_VERSION) && !defined(HEDLEY_TI_CL430_VERSION) &&      \
  !defined(HEDLEY_TI_CL2000_VERSION) && !defined(HEDLEY_TI_CL6X_VERSION) && !defined(HEDLEY_TI_CL7X_VERSION) && \
  !defined(HEDLEY_TI_CLPRU_VERSION) && !defined(__COMPCERT__) && !defined(HEDLEY_MCST_LCC_VERSION)
...
#endif
#if defined(__has_attribute) && ((!defined(HEDLEY_IAR_VERSION) || HEDLEY_IAR_VERSION_CHECK(8, 5, 9)))
...
#elif (HEDLEY_HAS_EXTENSION(attribute_deprecated_with_message) && !defined(HEDLEY_IAR_VERSION)) ||                     \
  HEDLEY_GCC_VERSION_CHECK(4, 5, 0) || HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) || HEDLEY_ARM_VERSION_CHECK(5, 6, 0) ||    \
  HEDLEY_SUNPRO_VERSION_CHECK(5, 13, 0) || HEDLEY_PGI_VERSION_CHECK(17, 10, 0) || HEDLEY_TI_VERSION_CHECK(18, 1, 0) || \
...
#define HEDLEY_DEPRECATED_FOR(since, replacement) \
  ...
  (HEDLEY_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) ||                               \
  HEDLEY_TI_CL6X_VERSION_CHECK(7, 5, 0) || HEDLEY_TI_CL7X_VERSION_CHECK(1, 2, 0) ||                                 \
  HEDLEY_TI_CLPRU_VERSION_CHECK(2, 1, 0) || HEDLEY_MCST_LCC_VERSION_CHECK(1, 25, 10) ||                             \
...
#undef HEDLEY_WARN_UNUSED_RESULT_MSG
  ...
  HEDLEY_PGI_VERSION_CHECK(17, 10, 0) || HEDLEY_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#undef HEDLEY_SENTINEL
  ...
  HEDLEY_ARM_VERSION_CHECK(5, 4, 0) || HEDLEY_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#elif HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) || HEDLEY_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#define HEDLEY_NO_RETURN HEDLEY_DIAGNOSTIC_DISABLE_CPP98_COMPAT_WRAP_([[noreturn]])
  ...
  (HEDLEY_TI_CL6X_VERSION_CHECK(7, 2, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) ||                                 \
  HEDLEY_TI_CL6X_VERSION_CHECK(7, 5, 0) || HEDLEY_TI_CL7X_VERSION_CHECK(1, 2, 0) ||                                   \
  HEDLEY_TI_CLPRU_VERSION_CHECK(2, 1, 0) || HEDLEY_IAR_VERSION_CHECK(8, 10, 0)
#define HEDLEY_NO_RETURN __attribute__((__noreturn__))
...
#define HEDLEY_ASSUME(expr) _nassert(expr)
  ...
  HEDLEY_GCC_VERSION_CHECK(4, 5, 0) || HEDLEY_PGI_VERSION_CHECK(18, 10, 0) || HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) || \
  HEDLEY_IBM_VERSION_CHECK(13, 1, 5) || HEDLEY_CRAY_VERSION_CHECK(10, 0, 0) ||                                        \
  HEDLEY_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#undef HEDLEY_MALLOC
  ...
  HEDLEY_SUNPRO_VERSION_CHECK(5, 11, 0) || HEDLEY_ARM_VERSION_CHECK(4, 1, 0) || HEDLEY_IBM_VERSION_CHECK(12, 1, 0) || \
  HEDLEY_TI_VERSION_CHECK(15, 12, 0) ||                                                                               \
  (HEDLEY_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) ||                                \
  HEDLEY_TI_ARMCL_VERSION_CHECK(5, 2, 0) ||                                                                           \
  (HEDLEY_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) ||                               \
...
#undef HEDLEY_PURE
  ...
  HEDLEY_SUNPRO_VERSION_CHECK(5, 11, 0) || HEDLEY_ARM_VERSION_CHECK(4, 1, 0) || HEDLEY_IBM_VERSION_CHECK(10, 1, 0) || \
  HEDLEY_TI_VERSION_CHECK(15, 12, 0) ||                                                                               \
  (HEDLEY_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) ||                                \
  HEDLEY_TI_ARMCL_VERSION_CHECK(5, 2, 0) ||                                                                           \
  (HEDLEY_TI_CL2000_VERSION_CHECK(6, 0, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__)) ||                               \
...
#define HEDLEY_RESTRICT restrict
  ...
  defined(__clang__) || HEDLEY_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#endif
#if HEDLEY_HAS_ATTRIBUTE(fallthrough) || HEDLEY_GCC_VERSION_CHECK(7, 0, 0) || HEDLEY_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#undef HEDLEY_IS_CONSTEXPR_
  ...
  HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) || HEDLEY_TINYC_VERSION_CHECK(0, 9, 19) || HEDLEY_ARM_VERSION_CHECK(4, 1, 0) || \
  HEDLEY_IBM_VERSION_CHECK(13, 1, 0) || HEDLEY_TI_CL6X_VERSION_CHECK(6, 1, 0) ||                                       \
  (HEDLEY_SUNPRO_VERSION_CHECK(5, 10, 0) && !defined(__cplusplus)) || HEDLEY_CRAY_VERSION_CHECK(8, 1, 0) ||            \
  HEDLEY_MCST_LCC_VERSION_CHECK(1, 25, 10)
#define HEDLEY_IS_CONSTANT(expr) __builtin_constant_p(expr)
  ...
  HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) || HEDLEY_IBM_VERSION_CHECK(13, 1, 0) || HEDLEY_CRAY_VERSION_CHECK(8, 1, 0) || \
...
#define HEDLEY_IS_CONSTEXPR_(expr) \
  ...
  (HEDLEY_HAS_EXTENSION(c_generic_selections) && !defined(HEDLEY_IAR_VERSION)) || HEDLEY_GCC_VERSION_CHECK(4, 9, 0) || \
...
#define HEDLEY_IS_CONSTEXPR_(expr) _Generic((1 ? (void *)((intptr_t)*0) : (int *)0), int * : 1, void * : 0)
  ...
  defined(HEDLEY_TI_ARMCL_VERSION) || HEDLEY_TI_CL430_VERSION_CHECK(18, 12, 0) || defined(HEDLEY_TI_CL2000_VERSION) || \
...
#undef HEDLEY_STATIC_ASSERT
  ...
  ((defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 201112L)) ||                                                    \
   (HEDLEY_HAS_FEATURE(c_static_assert) && !defined(HEDLEY_INTEL_CL_VERSION)) || HEDLEY_GCC_VERSION_CHECK(6, 0, 0) || \
